...
import CreateWelcomeHook from '../../hooks/Setting/welcome/create-welcome-hook';
import AllWelcomeMessageHook from '../../hooks/Setting/welcome/all-welcome-message-hook';
import DeleteWelcomeMessageHook from './../../hooks/Setting/welcome/delete-welcome-message-hook';
import EditWelcomeMessageHook from './../../hooks/Setting/welcome/edit-welcome-message-hook';

const WelcomeTable = () => {
    const [OnhandleClick, show, handleClose,handleShow ] = DeleteWelcomeMessageHook()
    const [ handleEdit, showEdit,handleCloseEdit,handleShowEdit ] = EditWelcomeMessageHook()
    const [ handleAdd, showAdd,handleCloseAdd,handleShowAdd ] = CreateWelcomeHook()
    const [rows,head,handleOpen ] = AllWelcomeMessageHook()
      ...
      return (
        ...
        <Modal show={showAdd} onHide={handleCloseAdd}>
          <Modal.Header closeButton>
            <Modal.Title><div> Create Welcome </div></Modal.Title>
          </Modal.Header> 
          <Modal.Body>
            ...
            <TableBody>
              {rows.map((row) => (
                ...
                >
                  ...
                  <TableCell  ><p>{row.subject}</p> </TableCell> 
                  <TableCell  >
