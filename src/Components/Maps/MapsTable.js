...
const MapsTable = () => {
    ...
    const [ handleAdd, showAdd,handleCloseAdd,handleShowAdd ] = AddMapsHook()
    const [rows,head,handleOpen ] = AllMapsHook()
      ...
      return (
        ...
        <Modal show={showAdd} onHide={handleCloseAdd}>
          ...
          <div className='mt-2 d-flex align-items-center gap-2'>
                <p style={{marginRight:"10px"}}>Stats Name:-</p>
                <select name='status' id='status'>
                    ...
                    <div className='mt-2 d-flex align-items-center gap-2'>
                <p style={{marginRight:"10px"}}>location name:-</p>
                <select name='status' id='status'>
                    <option>car</option>
                    <option>bus</option>
                    <option>taxi</option> 
                    ...
                    <div className='mt-2 d-flex align-items-center gap-2'>
                <p style={{marginRight:"10px"}}>Admin Unit Name:-</p>
                <select name='status' id='status'>
                    <option>car</option>
                    <option>bus</option>
                    <option>taxi</option> 
            ...
            <TableBody>
              {rows.map((row) => (
                ...
                >
                  ...
                  <TableCell  ><p>{row.locationName}</p> </TableCell> 
                  <TableCell  ><p>{row.admainName}</p> </TableCell> 
