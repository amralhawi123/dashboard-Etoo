...
const rows = [
  ...
  createData(<img style={{marginRight:"8px"}} src={brand3} alt="brand3"/>,'Github',"1.5K", "$1,768", 340, "2.8%"),
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead style={{backgroundColor: "#F7F9FC"}}>
          <TableRow>
            ...
            <TableCell align="right" className='fw-bold text-muted'>SALES</TableCell>
